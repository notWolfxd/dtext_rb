...
inline := |*
  ...
  'book #'i id      => { append_id_link("book", "book", "https://www.sankakucomplex.com/books/", { a1, a2 }); };
  'series #'i id      => { append_id_link("series", "series", "https://www.sankakucomplex.com/series/", { a1, a2 }); };
  'companion #'i id      => { append_id_link("companion", "companion", "https://www.sankakucomplex.com/companions/", { a1, a2 }); };
